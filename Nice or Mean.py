...
def score(nice,mean,name):
    ...
    if nice > 2: # if condition is valid, call win function passing in the varibles so it can use them
        win(nice,mean,name)
    if mean > 2: # if condition is valid, call lose function passing in the varibles so it can use them
        lose(nice,mean,name)
    else:       # else, call nice_mean function passing in the varibles so it can use them
...
def reset(nice,mean,name):
    nice = 0
    mean = 0
    #Notice, I do not reset the name varible as that same user has elected to play again
